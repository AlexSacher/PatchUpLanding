  ...
  return (
    ...
    >
      ...
      {(title1 || title2 || description) && (
        <div className="relative z-10 flex w-full flex-1 flex-col items-center justify-center pt-8 pb-8 md:pt-20 md:pb-20">
              ...
              {title1 && (
                <div className="overflow-hidden">
                  <motion.h1
                    ...
                    className="text-[12cqi] leading-[0.9] tracking-tighter text-[#131313] md:text-[8cqi] lg:text-[6cqi]"
                  >
                    <span className="font-serif font-light text-[#1a1a1a] italic">
                      {title1}
                    </span>
                  </motion.h1>
                </div>
              ...
              {title2 && (
                <div className="overflow-hidden">
                  <motion.h1
                    ...
                    className="text-[12cqi] leading-[0.9] font-bold tracking-tighter text-black md:text-[8cqi] lg:text-[6cqi]"
                  >
                    {title2}
                  </motion.h1>
                </div>
            ...
            {description && (
              <div className="mb-8 max-w-[480px] text-center">
                <motion.p
                  ...
                  className="text-lg leading-relaxed font-normal text-neutral-600 md:text-[1.35rem]"
                >
                  {description}
                </motion.p>
              </div>
